...
pub mod pallet {
    ...
    /// Id of creators of content in the system
    type CreatorId = u32;
	...
	pub struct Content {
		...
		claims: Vec<u32>,
        /// u32s representing ids of all creators of the content
        creators: Vec<u32>,
	}
	...
	pub struct Claim {
        ...
        /// u32 representing the creator who made the claim in the original content
        pub creator: Vec<u32>,
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn store_content(
			...
			let content = Content { url, claims, creators: [].to_vec() };
